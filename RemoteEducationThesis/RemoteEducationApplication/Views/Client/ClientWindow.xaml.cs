...
namespace Education.Application.Views.Client
{
	...
	public partial class ClientWindow : WindowBase
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Education.Application.Views.Client.ClientWindow"/> class.
		/// </summary>
		public ClientWindow()
		{
			InitializeComponent();
		...
		private void WebBrowser_Navigated(object sender, NavigationEventArgs e)
		{
			...
			if (webBrowser != null)
			{
				...
				if (urlParameters.Length > 0)
				{
					...
					Dictionary<int, string> urlParams = UrlHelper.GetUrlParameters<int, string>(urlParameters);

					Client.TotalScore += QuestionManager.CheckAnswers(urlParams);
					//ScoreProvider.SaveUserScore(Client.TotalScore);
					HasAnswered = true;
				}
				else
				{
		...
		private void Initialize()
		{
			...
			ClientHeight = ClientSizes.InitialHeight;
			ClientWidth = ClientSizes.InitialWidth;
			ScreenManager.InitializeBitmap();
		}
