...
using WindowRole = Education.Application.Managers.ApplicationManager.WindowBarRole;
...
namespace Education.Application.Views.UserControls
{
	...
	public partial class WindowBar : WpfUserControl
	{
		...
		public delegate void WindowBarClickEventHandler(object sender, ApplicationBarEventArgs e);
		...
		{
			WindowBarClick.ExecuteSafe(x => x(this, new ApplicationBarEventArgs(commandName: commandName)));
		}
